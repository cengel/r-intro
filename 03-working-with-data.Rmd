...
By default, when building or importing a data frame with `read.csv()`, the columns that contain characters (i.e., text) are read as such. (This was introduced in R Version 4.) Depending on what you intend to do with the data, you may want to keep these
